...
> **Android × iPhone** 両対応、**Claude Code / OpenAI Codex / Google Antigravity** で使える設計ですが、
> **実機で検証できているのは「Android ＋ Claude Code」だけ**です。
> iPhone・他エンジンは**コードとしては対応済み**ですが未検証なので、
> **あなたの端末・環境で実機確認して、必要なら編集して使ってください**（このリポはそれを前提に作っています）。
